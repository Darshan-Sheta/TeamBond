        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 pl-20">
          ...
          {!codeforcesData ? (
            ...
            <CodeforcesCard
              ...
              stats={[
                { label: "Rating", value: codeforcesData.currentRating },
                { label: "Max Rating", value: codeforcesData.maxRating },
                { label: "Rank", value: codeforcesData.rank },
              ]}
              imgUrl="https://cdn.iconscout.com/icon/free/png-256/free-code-forces-3628695-3029920.png"
            />
          )}
          ...
          {!codechefData ? (
            ...
            <div className="bg-gray-900/50 backdrop-blur-md rounded-lg p-6 border border-gray-700 flex items-center justify-center text-gray-400 col-span-1 md:col-span-2">
